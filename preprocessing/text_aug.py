# Adapted from https://github.com/jasonwei20/eda_nlp/blob/master/code/eda.py
...
########################################################################
# Back Translation
# Translate source sentence into another language and translate back
########################################################################
def back_translation(sentence):
	translator = BackTranslateAug()
